...
$builder->registerNamespace('microcache', false, true, '{core_path}components/' . PKG_NAME_LOWER . '/');

/* create plugin object */
$modx->log(xPDO::LOG_LEVEL_INFO,'Adding in plugin.'); flush();
$object= $modx->newObject('modPlugin');
$object->set('name', PKG_NAME);
$object->set('description', '<strong>'.PKG_VERSION.'-'.PKG_RELEASE.'</strong> Plugin for controlling HTTP caching headers for MODX Resources.');
$object->set('category', 0);
$object->set('plugincode', file_get_contents($sources['source_core'] . 'elements/plugins/microcache.php'));
